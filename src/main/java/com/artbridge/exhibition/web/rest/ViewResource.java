...
import com.artbridge.exhibition.infrastructure.repository.ViewRepository;
import com.artbridge.exhibition.application.service.ViewService;
...
public class ViewResource {
    ...
    private static final String ENTITY_NAME = "exhibitionView";
     ...
     */
    @PutMapping("/views/{id}")
    public ResponseEntity<ViewDTO> updateView(@PathVariable(value = "id", required = false) final String id, @RequestBody ViewDTO viewDTO)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, viewDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ViewDTO> partialUpdateView(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, viewDTO.getId())
        );
    }
     ...
     */
    @GetMapping("/views/{id}")
    public ResponseEntity<ViewDTO> getView(@PathVariable String id) {
