...
import com.artbridge.exhibition.infrastructure.config.KafkaSseConsumer;
import com.artbridge.exhibition.infrastructure.config.KafkaSseProducer;
...
public class ExhibitionKafkaResource {
    ...
    public ExhibitionKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
