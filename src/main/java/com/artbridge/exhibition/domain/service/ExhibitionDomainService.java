...
@Slf4j
@Service
public class ExhibitionDomainService {
    private final GCSService gcsService;
    private final TokenProvider tokenProvider;

    public ExhibitionDomainService(GCSService gcsService, TokenProvider tokenProvider) {
    ...
    public Exhibition initCreatedMember(Exhibition exhibition) {
        ...
        exhibition.getCreatedMember().setId(id);
        exhibition.getCreatedMember().setLogin(login);
        return exhibition;
